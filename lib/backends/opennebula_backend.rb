module Backends
  class OpennebulaBackend
    ...
    def initialize(delegated_user, options, server_properties, logger, dalli_cache)
      puts "daniel: opennebula_backend.rb enter initialize()"
    ...
    def init_connection(delegated_user, options)
      puts "daniel: opennebula_backend.rb enter init_connection()"
    ...
    def run_authn
      puts "daniel: opennebula_backend.rb enter run_authn()"
      return if @client
