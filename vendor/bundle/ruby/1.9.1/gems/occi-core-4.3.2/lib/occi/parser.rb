  ...
  module Parser
    ...
    class << self
      ...
      def parse(media_type, body, category=false, entity_type=Occi::Core::Resource, header={})
        ...
        File.open("/opt/rOCCI-server/daniel.log", "a+") { |f| f.puts " [daniel] Occi::Parser.parse(): enter." }
